...
export default function IframeBlocker({ children }: { children: React.ReactNode }) {
  ...
  // Siempre permitir acceso si hay algún error o en desarrollo
        ...
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <div className="bg-red-100 border border-red-300 rounded p-3 mb-4 text-left">
            <p className="text-sm text-red-700">
              <strong>Dominio:</strong> {parentDomain}<br/>
              <strong>En iframe:</strong> {isInIframe ? 'Sí' : 'No'}<br/>
              <strong>Permitido:</strong> {isAllowed ? 'Sí' : 'No'}
            </p>
          </div>
