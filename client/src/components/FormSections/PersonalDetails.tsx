...
import { genders, nationalities } from "@/lib/data";

export default function PersonalDetails() {
  const { control } = useFormContext();
  
  return (
    <section id="personal-details" className="bg-white p-6 shadow-md">
      <h2 className="important section-title">Datos Personales</h2>
