...
import { positions, locations, educationLevels, yesNoOptions, motivations } from "@/lib/data";

export default function EmploymentInfo() {
  const { control } = useFormContext();
  
  return (
    <section id="employment-info" className="bg-white p-6 shadow-md">
      <h2 className="important section-title">Información Laboral</h2>
