...
import { yesNoOptions, motivations } from "@/lib/data";

export default function EmploymentHistory() {
  const { control } = useFormContext();
  
  return (
    <section id="employment-history" className="bg-white p-6 shadow-md">
      <h2 className="important section-title">Experiencia Laboral</h2>
